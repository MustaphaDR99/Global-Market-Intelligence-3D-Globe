...
*   **Predictive Modeling**:
    *   **ARIMA**: Baseline statistical model for trend forecasting.
...
## 🛠️ Project Structure
*   `pipeline.py`: The data engine. Synchronizes global market index prices with macroeconomic data.
...
*   `main.py`: The orchestrator that executes the entire pipeline in sequence.
